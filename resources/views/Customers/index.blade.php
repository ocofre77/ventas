                                ...
                                <tbody>
                                  @foreach ($customers as $customer)
                                      <tr>
                                          ...
                                          <td>
                                              <a href="{{ route('Customers.edit', $customer->id )}}" type="button" class="btn btn-xs btn-warning">
                                                  <i class="fa fa-pencil" aria-hidden="true"></i> Editar</a>
                                              <a href="{{ route('Customers.destroy', $customer->id )}}" type="button" onclick="return confirm('Seguro en Eliminar?')" class="btn btn-xs btn-danger">
                                                  <i class="fa fa-trash" aria-hidden="true"></i> Borrar</a>
                                              <a href="{{ route('Trackings.create', $customer->id )}}" type="button" class="btn btn-xs btn-info">
